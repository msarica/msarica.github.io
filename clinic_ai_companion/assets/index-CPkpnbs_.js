      ...
      <div class="admin-settings">
        ...
        <form id="admin-settings-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="model" value="${this.escapeHtml(e.model)}" required>
          </div>
          <div class="form-group">
