...
let LocationService = class LocationService {
    constructor() {
        this.watchCoordinates$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.Subject();
    }
    isSupported() {
    ...
    watchLocation() {
        if (this.isSupported() === false) {
            setTimeout(() => {
                this.watchCoordinates$.error('not supported');
            });
        }
        navigator.geolocation.watchPosition((position) => {
            this.watchCoordinates$.next(position);
        }, (err) => {
            this.watchCoordinates$.error(err);
        });
        return this.watchCoordinates$;
    }
    calculateDistance(point1, point2) {
        return this.distance(point1.coords.latitude, point2.coords.latitude, point1.coords.longitude, point2.coords.longitude);
    }
    distance(lat1, lat2, lon1, lon2) {
        ...
        // for miles
        const r = 3956;
        // calculate the result in feet ( 1mile = 5280 feet)
        return (c * r) * 5280;
    }
};
LocationService.ctorParameters = () => [];
LocationService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var _Users_msarica_Desktop_Personal_Ionic_halloween_fun_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_msarica_Desktop_Personal_Ionic_halloween_fun_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_msarica_Desktop_Personal_Ionic_halloween_fun_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_msarica_Desktop_Personal_Ionic_halloween_fun_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
